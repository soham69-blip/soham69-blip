<h1 align="center">Hi 👋, I'm Soham Khurana</h1>

<h3 align="center">
  B.Tech IT Student | Software Developer | AI & Cloud Enthusiast
</h3>
...
* 🎓 B.Tech Information Technology student at Maharaja Agrasen Institute of Technology (MAIT), Delhi
* 📚 8.2 CGPA with strong foundations in Computer Science and Software Engineering
* 💻 Focused on Software Development, Data Structures & Algorithms, and Object-Oriented Programming
...
<p>
  ...
  <img src="https://img.shields.io/badge/Java-ED8B00?style=for-the-badge&logo=openjdk&logoColor=white" alt="Java">
  <img src="https://img.shields.io/badge/XML-0060AC?style=for-the-badge" alt="XML">
...
<p>
  ...
  <img src="https://img.shields.io/badge/CustomTkinter-3776AB?style=for-the-badge" alt="CustomTkinter">
</p>
...
An AI-powered clinical handoff system developed during **Microsoft Learn Student Chapter – Makeathon 8**.

**Tech Stack:** `Python` `LLMs` `Artificial Intelligence`
...
* 🏅 College Representative — NDTV Gadgets 360 Awards (2025–26)
* 📊 Secured **93.3 Percentile in JEE Main 2024**
* 📝 Received a **Letter of Recommendation from IIT Delhi**
* 🚀 Participated in multiple national-level hackathons and innovation competitions
...
* 📢 Led outreach campaigns and student engagement initiatives
* 📝 Received a Letter of Recommendation for outstanding contribution

---

## 📜 Certifications

* ☁️ **Gen AI Academy 2.0 – Data Track** — Google Cloud × Hack2Skill
* 🔐 **Cyber Security Program** — 1stop.ai × IIT Guwahati
* 💻 **Makeathon 8** — Microsoft Learn Student Chapter
* 🚀 **Makeathon 8** — Unstop × TIET
...
`Software Development` · `Java` · `C++` · `Python` · `DSA` · `OOP` · `Artificial Intelligence` · `LLMs` · `Machine Learning` · `Cloud Computing` · `Android Development` · `Problem Solving` · `Product Strategy` · `Startup Operations` · `Leadership` · `Team Collaboration`
...
### ⚡ Building Software. Exploring AI. Solving Real-World Problems.
